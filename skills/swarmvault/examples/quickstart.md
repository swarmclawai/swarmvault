...
- `wiki/graph/share-card.md` and `wiki/graph/share-card.svg` exist after compile, `graph share --post` prints copyable text, and `graph share --svg [path]` writes the visual card
